...
public class BoardDAO {
	...
	public List<ArticleVO> selectAllArticles(Map<String, Integer> pagingMap){
		...
		try {
			...
			query += " LVL, articleNO, parentNO, title, id, writeDate"; 
		    query += " FROM ( SELECT level as LVL, articleNO, parentNO, title, id, writeDate";
		    query += " FROM t_board START WITH parentNO=0 CONNECT BY PRIOR articleNO = parentNO";
	...
	public int insertNewArticle(ArticleVO article) {
		...
		try {
			...
			System.out.println("DAO 파일이름: " + imageFileName);
