...
.lst_type li{overflow:hidden;clear:both;margin:1px 0 0;color:#2d2c2d;
font-family:'돋움',Dotum;font-size:12px;line-height:100px;
list-style:none ; border-bottom: 2px solid lightgray;postion:relative; }
...
.lst_type li span{color:blue; margin-left:330px;font-familt:'돋움',Dotum;font-size:14px; }
}
</style>
<meta charset="UTF-8">
<title>이미지리스트 창</title>
</head>
<body>
	<ul class="lst_type">
		<li>
		...
		<li>
			<a href='#' style='margin-left:50px' >
				<img src='image/cattt.jpg' width='90' height='90' alt='' /></a>	
			<a href='#'><strong>이미지 이름: 애옹<%=i %></strong></a>		
