...
public class CalcServlet extends HttpServlet{
	...
	private static final float USD_RATE = 1000;
	private static final float JPY_RATE = 100;
	private static final float CNY_RATE = 5;
	private static final float GBP_RATE = 3;
	private static final float EUR_RATE = 2;
