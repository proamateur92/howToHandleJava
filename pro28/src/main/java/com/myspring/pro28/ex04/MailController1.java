...
public class MailController1 {
	...
	@RequestMapping(value="/sendMail1.do", method=RequestMethod.GET)
	public void sendSimpleMail(HttpServletRequest request,
		...
		sb.append("<html><body>");
		sb.append("<meta http-eqiv='Content-Type' content='text/html; charset-euc-kr'>");
		...
		mailService.sendMail("im_u440k@naver.com", "신상품을 소개합니다", str);
		out.print("메일을 보냈습니다!!");
	}
}
